  ...
  <body onload="count();" style="background-color: silver;">
	   <body onload="count();" style="background-color: silver;">
		...
		<table width="100%">
	    	...
	    	<tr>
	    		<td align="center" style="color: #ffffff; font-size: 25px;"><b>Thank You..</b></td>
	   		</tr>
	   		<tr>
	    		<td align="center"><hr/>&nbsp;</td>
	   		</tr>
	   		<tr>
	    		<td style="color: #ffffff; font-size: 20px; line-height: 1.7em;" align="center"><b>You have successfully completed your exam. Check your result in result section but your score card will be generated at end of the month. </b></td>
	   		</tr>
	   		<tr>
	    		<td align="center">&nbsp;</td>
	   		</tr>
	   		<tr>
	    		<td align="center"><img alt="" src="image/result.png" width="700px" height="180px"></td>
	   		</tr>
	    </table>
		</div>
	    ...
	    <tr>
	    <td width="100%" align="center"><button onclick="finish()" style="background-color: #DF7401" class="myButton">Finish</button></td>
	    </tr>
