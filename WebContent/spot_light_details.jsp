...
<html>
	<head>
		<title>XamDesk | <%=spotLightDetailsDto.getOstr_headline()%></title>
		<link rel='shortcut icon' type='image/x-icon' href='image/favicon.ico'/>
		<meta charset="utf-8" />
		<meta name="viewport" content="width=device-width, initial-scale=1" />
		
		<meta name="url" content="https://www.xamdesk.com/contenttype=<%=Encryption.encryptText(spotLightDetailsDto.getOnum_id().toString())%>"/>
		<meta name="title" content="<%=spotLightDetailsDto.getOstr_headline()%>"/>
		<meta name="description" content="<%=spotLightDetailsDto.getOstr_short_description()%>"/>
		<meta name="image" content="https://www.xamdesk.com/<%=spotLightDetailsDto.getOstr_image_url()%>"/>

		
		<!-- <meta property="og:locale" content="hi_IN"/> -->
		<meta property="og:type" content="website"/>
		<meta property="og:site_name" content="XamDesk"/>
		<meta property="og:url" content="https://www.xamdesk.com/showStudentMaterialsDetails?contenttype=<%=Encryption.encryptText(spotLightDetailsDto.getOnum_id().toString())%>"/>
		<meta property="og:title" content="<%=spotLightDetailsDto.getOstr_headline()%>"/>
		<meta property="og:description" content="<%=spotLightDetailsDto.getOstr_short_description()%>"/>
		<meta property="og:updated_time" content="<%=spotLightDetailsDto.getOdt_entry_date()%>"/>
		<meta property="og:image" content="https://www.xamdesk.com/<%=spotLightDetailsDto.getOstr_image_url()%>"/>
    	...
    	<meta name="twitter:title" content="<%=spotLightDetailsDto.getOstr_headline()%>">
    	<meta name="twitter:description" content="<%=spotLightDetailsDto.getOstr_short_description()%>">
    	<meta name="twitter:creator" content="@xamdesk">
    	<meta name="twitter:image:src" content="https://www.xamdesk.com/<%=spotLightDetailsDto.getOstr_image_url()%>">
    	<meta name="twitter:image:alt" content="<%=spotLightDetailsDto.getOstr_headline()%>" />
    	<meta name="twitter:domain" content="https://www.xamdesk.com/">
    	<meta name="twitter:image:width" content="850"/>
		<meta name="twitter:image:height" content="550"/>
		
		<link rel="canonical" href="https://www.xamdesk.com/showStudentMaterialsDetails?contenttype=<%=Encryption.encryptText(spotLightDetailsDto.getOnum_id().toString())%>"/>
							...
							<!-- Feature 1 -->
								<section class="container box feature1"style="width: 80%;">
									<div style="width: 50%; float: left;" align="left">	
											<div class="fb-like" data-href="https://www.xamdesk.com/contenttype=<%=Encryption.encryptText(spotLightDetailsDto.getOnum_id().toString())%>" data-layout="button_count" data-action="like" data-size="small" data-show-faces="true" data-share="true"></div>										
											<div class="fb-follow" data-href="https://www.facebook.com/xamdesk/" data-layout="button" data-size="small" data-show-faces="true"></div>
											<div class="fb-save" data-uri="https://www.xamdesk.com/contenttype=<%=Encryption.encryptText(spotLightDetailsDto.getOnum_id().toString())%>" data-size="small"></div>
											</div>
									...
									<div class="row">
										<div class="12u">
											<span class="date" align="left"><%=fmt.format(spotLightDetailsDto.getOdt_entry_date())%></span>
											<h2 align="left"><%=spotLightDetailsDto.getOstr_headline()%></h2>
											<div style="color: #000000;"><%=spotLightDetailsDto.getOstr_message()%></div>						
												
											
											<div style="width: 50%; float: left;" align="left">	
											<div class="fb-like" data-href="https://www.xamdesk.com/contenttype=<%=Encryption.encryptText(spotLightDetailsDto.getOnum_id().toString())%>" data-layout="button_count" data-action="like" data-size="large" data-show-faces="true" data-share="true"></div>										
											<div class="fb-follow" data-href="https://www.facebook.com/xamdesk/" data-layout="button" data-size="large" data-show-faces="true"></div>
											<div class="fb-save" data-uri="https://www.xamdesk.com/contenttype=<%=Encryption.encryptText(spotLightDetailsDto.getOnum_id().toString())%>" data-size="large"></div>
											</div>
											...
											<a href="https://twitter.com/share" class="twitter-share-button" data-size="large" data-url="https://www.xamdesk.com/contenttype=<%=Encryption.encryptText(spotLightDetailsDto.getOnum_id().toString())%>" data-show-count="false">Tweet</a>
											</div>										
										</div>
									</div>
								</section>
							...
							<div class="container">
								...
								<%if(blogDetailsDtoList != null && blogDetailsDtoList.size()>0) {
									...
									<header>
										...
										<h3><a href="showStudentMaterialsDetails?contenttype=<%=Encryption.encryptText(dto.getOnum_id().toString())%>"><%=dto.getOstr_headline()%></a></h3>
									</header>
					
									<div>
										<a href="showStudentMaterialsDetails?contenttype=<%=Encryption.encryptText(dto.getOnum_id().toString())%>" class="image left"><img src="<%=dto.getOstr_image_url()%>" alt="<%=dto.getOstr_headline()%>" width="100%" height="100%"/></a>
