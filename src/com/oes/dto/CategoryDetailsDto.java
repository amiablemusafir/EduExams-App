...
@Entity @Table(name = "oes_category_details") @Proxy(lazy=false)
public class CategoryDetailsDto implements Serializable{
	...
	@Column(name = "ostr_category_name")
	private String ostr_category_name;
	
	@Column(name = "ostr_category_details")
    private String ostr_category_details;
	...
	public String getOstr_category_name() {
		return ostr_category_name;
	}

	public void setOstr_category_name(String ostr_category_name) {
		this.ostr_category_name = ostr_category_name;
	}

	public String getOstr_category_details() {
		return ostr_category_details;
	}

	public void setOstr_category_details(String ostr_category_details) {
		this.ostr_category_details = ostr_category_details;
	}
